//BASE AINE, DI RECODE OLEH RIFQIBOTZ
// WA = 085643112659
...
const connectionOptions = {
  ...
  browser: ['MIAW BOTZ','Safari','1.0.0'],
  auth: state,
...
async function connectionUpdate(update) {
  ...
  if (update.receivedPendingNotifications) conn.sendMessage(`628565337357@s.whatsapp.net`, {text: `Successfully connected by ${namabot}` }) //made by Muhammad Ridwan Reynaldy 
  conn.updateBlockStatus(`628565337357@s.whatsapp.net`, "unblock")
}
